...
const AtelierScene = dynamic(() => import("./AtelierScene"), { ssr: false });
  ...
  return <section ref={ref} className="atelier-hero" aria-label="L’Atelier d’Or — die Fassung entdecken">
    <div className="atelier-stage">
      <motion.div className="atelier-title" style={{ y: titleY, opacity: reduced ? 1 : titleOpacity }}>
        ...
        <h1>Le sens <em>du détail.</em></h1>
        <p className="atelier-title-note">Für einen Blick, der bleibt.</p>
      </motion.div>
      <div className="atelier-scene"><AtelierScene progress={progress} tint={finish} reduced={!!reduced} /></div>
      ...
      <div className="atelier-scroll-hint"><span>SCROLL TO EXPLORE</span><span>↓</span></div>
