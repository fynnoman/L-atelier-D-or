...
export const PIECES: Piece[] = [
  {
    ...
    numeral: "I",
    name: "Roi Rouge",
    tagline: "Eine Glut unter dem Samt.",
  ...
  },
  {
    ...
    numeral: "II",
    name: "Roi Noir",
    tagline: "Der Schatten des Unterholzes, auf den Millimeter gehalten.",
  ...
  },
  {
    ...
    numeral: "III",
    name: "Roi Cristal",
    tagline: "Die Klarheit des Porzellans, die Weichheit des Satins.",
  ...
  },
  {
    ...
    numeral: "IV",
    name: "Roi Émeraude",
    tagline: "Ein Garten nach Einbruch der Nacht.",
